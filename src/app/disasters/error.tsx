...
export default function DisastersError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Disasters page error:", error);
  }, [error]);
      ...
      <section className="bg-ocean-900/50 border-b border-ocean-700">
        <div className="container-content py-8 md:py-12">
          ...
          <p className="text-foam-200">
            Real-time tracking of natural disasters worldwide.
          </p>
        </div>
      </section>
        ...
        <div className="container-content">
          <div className="card p-8 md:p-12 text-center max-w-lg mx-auto">
            ...
            <p className="text-foam-200 mb-6">
              We couldn&apos;t fetch the latest disaster information. This may
              be a temporary issue with our data sources.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                ...
                aria-label="Try loading disasters again"
              >
                Try Again
              </button>
              <a
